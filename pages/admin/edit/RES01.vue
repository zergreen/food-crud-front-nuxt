<template>
  <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
    ...
    <button @click="giveParams">test</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    giveParams() {
      // Get the params object from the $route object
      console.log("hello world");
      const params = this.$route.params;
      console.log(this.$route);
      console.log(params);
      // Get the last property of the params object
      const lastParam = Object.values(params)[Object.values(params).length - 1];
